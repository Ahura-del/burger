  ...
  const rightActions = (progress, dragX) => {
    ...
    return (
      <View style={{justifyContent: 'center'}}>
        <Button  style={{height: 60 , width:60 , backgroundColor:"red"}} onPress={()=>dispatch(delCart(props.data.id))}>
          ...
          <View
            ...
            <View>
              ...
              <View style={{flexDirection: 'row', marginBottom: 10}}>
                <FontAwesomeIcon icon={faStar} color="yellow" style={{marginRight:5,fontSize: 10}} />
                <FontAwesomeIcon icon={faStar} color="yellow" style={{marginRight:5,fontSize: 10}} />
                <FontAwesomeIcon icon={faStar} color="yellow" style={{marginRight:5,fontSize: 10}} />
                <FontAwesomeIcon icon={faStar} color="yellow" style={{marginRight:5,fontSize: 10}} />
                <FontAwesomeIcon icon={faStar} color="yellow" style={{marginRight:5,fontSize: 10}} />
            ...
            <View
              ...
              <View style={{flexDirection: 'row'}}>
                <View>
                  ...
                  <FontAwesomeIcon icon={faMinusCircle} color="#111" size={20} />
                ...
                <FontAwesomeIcon icon={faPlusCircle} color="#111" size={20} />

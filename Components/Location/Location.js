      ...
      <View style={{flex: 1,width: '90%', marginLeft: 'auto', marginRight: 'auto', justifyContent:"space-around" }}>
          ...
          <View
            ...
            <View style={{flex: 2, marginRight: 10}}>
              <Text style={{color: '#FEB500', fontSize: responsiveScreenFontSize(2), fontFamily: 'Poppins', textTransform:"capitalize"}}>
              {route.params=== undefined ? "Nana Varachha" : route.params.city}
                
              </Text>
              <Text style={{color: '#fff', fontSize: responsiveScreenFontSize(1.5), fontFamily: 'Poppins'}}>
            ...
            <View style={{flex: 1, marginTop: 20}}>
              <Button size='md' style={{backgroundColor:"#FEB500"}}onPress={()=>{navigation.navigate("NewLocation" , {userId})}}>
                <Text style={{fontFamily: 'Poppins',color:"#000",fontSize:responsiveScreenFontSize(1.7)}}>CHANGE</Text>
              </Button>
            </View>
          </View>
          <View>
            <Button size='md' style={{backgroundColor:"#FEB500"}} onPress={()=>{navigation.navigate("Home")}}>
              <Text style={{fontFamily: 'Poppins',color:"#000",fontSize:responsiveScreenFontSize(2)}} >Confirm Location</Text>
            </Button>
          </View>
